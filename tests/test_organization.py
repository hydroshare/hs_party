...
from ..models import Organization, Person,OrgAssociations, ExternalOrgIdentifiers,OrganizationType,ExternalIdentifierType
...
class organizationTest(TestCase):
    ...
    def setUp(self):
        ...
        org2 = Organization.objects.create(name="org2",organizationType=otherChoice)
        ...
        org3 = Organization.objects.create(name="org3",organizationType=otherChoice)
        ...
        ExternalOrgIdentifiers.objects.create(organization=org2,identifierName=idChoice,identifierCode="code1")
    ...
    def test_organization(self):
        ...
        self.assertEqual(org1.hs_scholar_profile_personmodel_members.count(), 0)
        org2 = Organization.objects.get(name="org2")
        self.assertEqual(org2.hs_scholar_profile_personmodel_members.count(), 2)
        ...
        self.assertEqual(org3.hs_scholar_profile_personmodel_members.count(), 2)
